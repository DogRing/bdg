...
Concept & rationale: `docs/core/design.md §5`(바탕재료·연속좌표·navmap 인덱스), `docs/plans/resources.md` §0/R7(자원↔terrain affinity),
`docs/plans/fauna.md` F18(적합도 spawn), `docs/plans/flora.md`(suitability), 메모리 `live-emergence-underseeded`(초기 시딩 레버).
