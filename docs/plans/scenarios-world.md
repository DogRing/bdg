...
**물리/세계 층 통합-테스트 카탈로그.** `docs/core/testing.md §4`의 사회 시나리오(A–L)를 보완한다 — 이쪽은
...
> 신규 fauna 층(`docs/plans/fauna.md`, `docs/plans/world-integration.md` WI-P2). 단언은 *행동 트리가 아니라*
