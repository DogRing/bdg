...
Concept & rationale: `docs/core/design.md §5`(바탕재료 sand/soil/river/mountain/sea + 속성), `§9`(경제 — `currency` 이연),
`docs/plans/materials.md`(FINAL recipe model · `ore_node`/`Mine`/`source:` · Q4 "추출=terrain 변형" · Q5 "광물=유한·희소").
