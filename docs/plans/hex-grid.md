...
Concept & rationale: this file. Sits beside `docs/plans/map.md` (that plan built the square grid; this
...
> space. No `docs/core/design.md` invariant edit / approval is required.
...
- `docs/core/data-contracts.md` — `/api/terrain` + `WorldFrame.terrain_delta` `cell` encoding + grid shape.
- `backend/tools/worldgen/SPEC.md` — `TerrainLayout` hex representation (see Q5).
- `docs/plans/map.md` (substrate note cross-link), `docs/core/glossary.md` (cell vocabulary).
