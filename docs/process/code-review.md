# code-review.md — review checklist for `bdg` (Codex + humans)
...
- Package name matches; canonical `docs/core/glossary.md` names used (no synonyms/coinages).
...
## 6. Invariants & gate
- The design invariants (D1–D12, `CLAUDE.md`/`docs/core/design.md`) are honored — and intentional ones are
